...
function PreBuildMap()
    -- Spawn ziplines
    AddZipLine(vector:new(-714, -5150, 61), vector:new(-72, -3954, 48))
    AddZipLine(vector:new(1056, -2794, 88), vector:new(245, -3959, 48))
    AddZipLine(vector:new(1645, -1552, 29), vector:new(27, -496, -43))
    AddZipLine(vector:new(1252, 180, -321), vector:new(1677, -1362, 1))
    AddZipLine(vector:new(2630, -3384, -175), vector:new(1062, -2322, 124))
    AddZipLine(vector:new(15, -5194, -285), vector:new(-497, -5177, 11))

    -- Spawn shop
    SpawnShopKillStreak(vector:new(-1329, -7191, -321), vector:new(0, 0, 0))
    SpawnShopWeapon(vector:new(-1325, -6961, -322), vector:new(0, 180, 0))
end
