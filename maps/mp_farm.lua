...
function PreBuildMap()
    ...
    SpawnZipLineBothWays(vector:new(3098, 2396, 269), vector:new(4234, 2402, 761))
    SpawnZipLineBothWays(vector:new(4829, 2354, 761), vector:new(1485, 1885, 590))
    ...
    -- Spawn shop
    SpawnShop(vector:new(4247, 2200, 431), vector:new(0, 0, 0), "compass_objpoint_airstrike")
end
