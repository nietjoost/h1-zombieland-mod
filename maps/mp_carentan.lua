...
function PreBuildMap()
    -- Spawn ziplines
    AddZipLine(vector:new(-304, 436, 130), vector:new(-219, 779, 122))
    AddZipLine(vector:new(-101, 783, 122), vector:new(-607, 1680, 149))
    AddZipLine(vector:new(-237, 1931, 154), vector:new(695, 3120, 157))

    -- Spawn boosters
    AddBooster(vector:new(-662, 409, 7), 30)
    AddBooster(vector:new(726, 3637, -23), 30)
    AddBooster(vector:new(-382, 1984, -23), 30)

    -- Spawn shop
    SpawnShopKillStreak(vector:new(3744, 1677, -37), vector:new(0, 180, 0))
    SpawnShopWeapon(vector:new(115, 1598, 0), vector:new(0, 0, 0))
end
